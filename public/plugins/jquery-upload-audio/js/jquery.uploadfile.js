...
(function ($) {
    ...
    $.fn.lfUploadFile = function (options) {
        ...
        this.setheaders = function (property, value) {
            s.headers[ property ] = value;
        },
            ...
            var options = {
                ...
                beforeSubmit: function (formData, $form, options) {
                    if(s.onSubmit.call(this, fileArray) != false) {
                        $(obj).find('.ajax-file-upload-filename').addClass('ajax-please-wait-style').html('Your file is uploading, please wait');
